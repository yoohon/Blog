...
public class FileUtil {
    ...
    public List<FileVO> saveAllFiles(List<MultipartFile> upfiles) {
        String filePath = "/Users/yoojuhyun/Desktop/sts/Practice1/src/main/fileUpLoad"; 
        ...
        for (MultipartFile uploadfile : upfiles ) {
            ...
            saveFile(uploadfile, filePath + "/" + newName.substring(0,4) + "/", newName + getFileExtension(uploadfile.getOriginalFilename()));
